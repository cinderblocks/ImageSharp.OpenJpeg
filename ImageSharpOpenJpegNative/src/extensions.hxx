...
IMAGESHARPOPENJPEG_EXPORT int32_t openjpeg_openjp2_extensions_imagetobmp(opj_image_t * image, 
																		 uint8_t** planes,
																		 uint32_t* out_w,
																		 uint32_t* out_h,
																		 uint32_t* out_c,
...
IMAGESHARPOPENJPEG_EXPORT int32_t openjpeg_openjp2_extensions_imagetotga(opj_image_t * image, 
                                                         uint8_t** out_tga, 
                                                         uint32_t* out_size,
                                                         uint32_t* out_w,
                                                         uint32_t* out_h,
...
IMAGESHARPOPENJPEG_EXPORT int32_t openjpeg_openjp2_extensions_tgatoimage(uint8_t * tga_image,
